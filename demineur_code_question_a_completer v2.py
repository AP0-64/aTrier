...
### QUESTION : compléter le code de la fonction suivante
def action_clic_decouvre(clic)->None:
    """
...
largeur = 20                # largeur du plateau, en nombre de cases
...
grille.bind("<Button-1>", action_clic_decouvre)
